...
public enum RIHNVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
//@formatter:off
    /** prixMaximal.         */ prixMaximal            ("prixMaximal",            ANNOTATION_PROPERTY);
...
//@formatter:on
	...
	RIHNVocabulary(final String localname, final EntityType<?> entityType) {
		this.localName = localname;
		this.prefixedName = NameSpace.RIHN.getPrefixName() + ':' + localname;
		this.entityType = entityType;
		this.iri = IRI.create(NameSpace.RIHN.toString(), localname);
	}

	private static Stream<RIHNVocabulary> stream() {
